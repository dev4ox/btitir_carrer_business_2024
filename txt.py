SPECIALIST_LIST = ['Оператор информационных систем и ресурсов', 'Экономика и бухгалтерский учет (по отраслям)',
                   'Разработка электронных устройств и систем', 'Информационные системы и программирование']
