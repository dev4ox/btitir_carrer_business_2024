...
specialists = (f'Список направлений для обучения:\n'
               ...
               f'4. <b>{SPECIALIST_LIST[3]}</b>\n'
               f'<i>09.01.03 | Основное общее | Очная | 1 года 10 месяцев</i>\n')


def quiz_finall(result_code: str):
    if not result_code == '0000':
        ...
        if len(result_index) > 1:
            ...
            return f'⭐⭐⭐ Воу воу, полегче! ⭐⭐⭐\nДля тебя есть целый список профессий:\n{result_text}'
        else:
            return f'🤩🤩🤩 А ты хорош! 🤩🤩🤩\nТебе подойдет профессия:\n<b>{SPECIALIST_LIST[result_index[0]]}</b>'
    else:
